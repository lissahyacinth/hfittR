request_table =
 data.table("request_name" = c("all routes",
                               "all lines",
                               "all line arrivals",
                               "line arrivals for stopPoint",
                               "route section",
                               "all modes",
                               "stopPoint arrival prediction",
            ...
            "base_url" = c("https://api.tfl.gov.uk/Line/Mode/{Mode}/Route",
                           ...
                           "https://api.tfl.gov.uk/line/{Line}/arrivals?{StopPoint}",
...
devtools::use_data(request_table, argument_table, internal = FALSE, overwrite = T)